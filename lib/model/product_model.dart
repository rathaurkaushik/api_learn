...
class Products {
  ...
  Products.fromJson(Map<String, dynamic> json) {
    ...
    stock = json['stock'];
    tags = json['tags']?.cast<String>(); // Handle nullable tags
    brand = json['brand'];
    sku = json['sku'];
    weight = json['weight'];
    ...
    images = json['images']?.cast<String>(); // Handle nullable images
...
class Dimensions {
  ...
  Dimensions.fromJson(Map<String, dynamic> json) {
    width = (json['width'] as num?)?.toDouble();  // Convert to double if necessary
